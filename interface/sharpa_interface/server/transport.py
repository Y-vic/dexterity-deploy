"""Synchronous HTTP/WebSocket transport for SharpA policy server v3."""
...
class SharpaV3PolicyClient:
    ...
    The v3 WebSocket does not send an application-level metadata message
    after the upgrade. Metadata is fetched over HTTP before it is opened.
    """
